            ...
            <div class="row">
                <div class="col-md-6 text-center text-lg-left mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-white pr-3" href="/admin">Logout</a>
                    </div>
                </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="adminOrder.blade.php" class="underline text-gray-900 dark:text-white">Order Details</a></div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="adminContect.blade.php" class="underline text-gray-900 dark:text-white">Custemer Reviews</a></div>
                            </div>
                        </div>            
                    </div>
                </div>
