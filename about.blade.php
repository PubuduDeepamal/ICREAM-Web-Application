    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <h1 class="section-title position-relative text-center mb-5">Traditional & Delicious Ice Cream</h1>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 py-5">
                    <h4 class="font-weight-bold mb-3">Since 2022</h4>
                    <p>it’s a friendly staff surrounded with calm and relaxing background. Anyone can have a delicious meal for a reasonable price. As well as, it is an ideal place for a get together, parties or any kind of family functions.</p>
    ...
    <div class="container-fluid footer bg-light py-5" style="margin-top: 90px;">
        <div class="container text-center py-5">
            <div class="row">
                ...
                <div class="col-12">
                <p class="m-0">&copy; All Rights Reserved. Designed by <a href="admin.blade.php">Pubudu/a></a>
                    </p>
                </div>
            </div>
        </div>
